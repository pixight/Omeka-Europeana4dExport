    ...
    <form action="<?php echo html_escape(url('items/batch-edit')); ?>" method="post" accept-charset="utf-8">
        ...
        <thead>
            <tr>
                ...
                $browseHeadings[__('Publisher')] = 'Dublin Core,Publisher';
                $browseHeadings[__('Is Part Of')]  = 'Dublin Core,Is Part Of';
                $browseHeadings[__('Contributor')] = 'Dublin Core,Contributor';
                $browseHeadings[__('Date')] = 'Dublin Core,Date'; //Ajout de la colonne Date
                $browseHeadings[__('Language')]  = 'Dublin Core,Language';
                $browseHeadings[__('Coverage')]  = 'Dublin Core,Coverage';
                $browseHeadings[__('Extent')]  = 'Dublin Core,Extent';
        ...
        <tbody>
            ...
            <tr class="item <?php if(++$key%2==1) echo 'odd'; else echo 'even'; ?>">
                ...
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Publisher'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Is Part Of'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Contributor'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Date'))); ?></td> <?php // Ajout de la colonne date ?>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Language'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Coverage'))); ?></td>
                <td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Extent'))); ?></td>
                <?php /*<td><?php echo strip_formatting(metadata('item', array('Dublin Core', 'Creator'))); ?></td>
                <td>
                    <?php
