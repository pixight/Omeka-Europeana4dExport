 ...
 * @package Europeana4dExport/Controllers
 */
class Europeana4dExport_ItemsController extends Omeka_Controller_AbstractActionController
{
    const PROCESS_CLASS_EXPORTALL = 'Europeana4dExport_ExportAllProcess';

    public $contexts = array(
            'browse' => array('json', 'dcmes-xml', 'rss2', 'omeka-xml', 'omeka-json', 'atom', 'europeana-kml'),
    ...
    public function _getBrowseRecordsPerPage()
    {
        ...
        if($output = $this->getRequest()->get('output')){
            if($output = 'europeana-kml'){
                return $perPage = null;
            }            
        }
